...
/**
 * This is the model class for table "ap3Ind31_hist".
 *
 * The followings are the available columns in table 'ap3Ind31_hist':
 * @property integer $id
 ...
 */
class Ap3Ind31Hist extends CActiveRecord
{
    public $_archivo;
	/**
