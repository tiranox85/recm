...
/**
 * This is the model class for table "ap8Ind14_hist".
 *
 * The followings are the available columns in table 'ap8Ind14_hist':
 * @property integer $id
 ...
 */
class Ap8Ind14Hist extends CActiveRecord
{
    public $_archivo;
	/**
