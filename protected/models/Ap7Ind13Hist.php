...
/**
 * This is the model class for table "ap7Ind13_hist".
 *
 * The followings are the available columns in table 'ap7Ind13_hist':
 * @property integer $id
 ...
 */
class Ap7Ind13Hist extends CActiveRecord
{
    public $_archivo;
	/**
