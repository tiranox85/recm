...
/**
 * This is the model class for table "ap1Ind61_hist".
 *
 * The followings are the available columns in table 'ap1Ind61_hist':
 * @property integer $id
 ...
 */
class Ap1Ind61Hist extends CActiveRecord
{
    public $_archivo;
	/**
