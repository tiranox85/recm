...
/**
 * This is the model class for table "ap3Ind11_hist".
 *
 * The followings are the available columns in table 'ap3Ind11_hist':
 * @property integer $id
 ...
 */
class Ap3Ind11Hist extends CActiveRecord
{
    public $_archivo;
	/**
