...
/**
 * This is the model class for table "ap1Ind44_hist".
 *
 * The followings are the available columns in table 'ap1Ind44_hist':
 * @property integer $id
 ...
 */
class Ap1Ind44Hist extends CActiveRecord
{
    public $_archivo;
	/**
