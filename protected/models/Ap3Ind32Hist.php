...
/**
 * This is the model class for table "ap3Ind32_hist".
 *
 * The followings are the available columns in table 'ap3Ind32_hist':
 * @property integer $id
 ...
 */
class Ap3Ind32Hist extends CActiveRecord
{
    public $_archivo;
	/**
