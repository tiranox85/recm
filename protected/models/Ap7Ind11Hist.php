...
/**
 * This is the model class for table "ap7Ind11_hist".
 *
 * The followings are the available columns in table 'ap7Ind11_hist':
 * @property integer $id
 ...
 */
class Ap7Ind11Hist extends CActiveRecord
{
    public $_archivo;
	/**
