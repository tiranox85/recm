...
/**
 * This is the model class for table "ap1Ind82_hist".
 *
 * The followings are the available columns in table 'ap1Ind82_hist':
 * @property integer $id
 ...
 */
class Ap1Ind82Hist extends CActiveRecord
{
	/**
	 ...
	 * @return Ap1Ind82Hist the static model class
	 */
