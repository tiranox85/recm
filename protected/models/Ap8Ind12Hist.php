...
/**
 * This is the model class for table "ap8Ind12_hist".
 *
 * The followings are the available columns in table 'ap8Ind12_hist':
 * @property integer $id
 ...
 */
class Ap8Ind12Hist extends CActiveRecord
{
    public $_archivo;
	/**
