...
/**
 * This is the model class for table "ap8Ind22_hist".
 *
 * The followings are the available columns in table 'ap8Ind22_hist':
 * @property integer $id
 ...
 */
class Ap8Ind22Hist extends CActiveRecord
{
    public $_archivo;
	/**
