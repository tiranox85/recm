...
/**
 * This is the model class for table "ap1Ind43_hist".
 *
 * The followings are the available columns in table 'ap1Ind43_hist':
 * @property integer $id
 ...
 */
class Ap1Ind43Hist extends CActiveRecord
{
    public $_archivo;
	/**
