...
/**
 * This is the model class for table "ap1Ind84_hist".
 *
 * The followings are the available columns in table 'ap1Ind84_hist':
 * @property integer $id
 ...
 */
class Ap1Ind83Hist extends CActiveRecord
{
	/**
	 ...
	 * @return Ap1Ind84Hist the static model class
	 */
