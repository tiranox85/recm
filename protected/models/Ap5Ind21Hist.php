...
/**
 * This is the model class for table "ap5Ind21_hist".
 *
 * The followings are the available columns in table 'ap5Ind21_hist':
 * @property integer $id
 ...
 */
class Ap5Ind21Hist extends CActiveRecord
{
    public $_archivo;
	/**
