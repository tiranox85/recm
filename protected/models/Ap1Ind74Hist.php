...
/**
 * This is the model class for table "ap1Ind74_hist".
 *
 * The followings are the available columns in table 'ap1Ind74_hist':
 * @property integer $id
 ...
 */
class Ap1Ind74Hist extends CActiveRecord
{
    public $_archivo;
	/**
