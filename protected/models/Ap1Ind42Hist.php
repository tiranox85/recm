...
/**
 * This is the model class for table "ap1Ind42_hist".
 *
 * The followings are the available columns in table 'ap1Ind42_hist':
 * @property integer $id
 ...
 */
class Ap1Ind42Hist extends CActiveRecord
{
    public $_archivo;
	/**
