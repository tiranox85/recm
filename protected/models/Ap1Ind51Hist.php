...
/**
 * This is the model class for table "ap1Ind51_hist".
 *
 * The followings are the available columns in table 'ap1Ind51_hist':
 * @property integer $id
 ...
 */
class Ap1Ind51Hist extends CActiveRecord
{
    public $_archivo;
	/**
