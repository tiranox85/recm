...
/**
 * This is the model class for table "ap3Ind33_hist".
 *
 * The followings are the available columns in table 'ap3Ind33_hist':
 * @property integer $id
 ...
 */
class Ap3Ind33Hist extends CActiveRecord
{
    public $_archivo;
	/**
