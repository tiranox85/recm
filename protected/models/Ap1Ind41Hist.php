...
/**
 * This is the model class for table "ap1Ind41_hist".
 *
 * The followings are the available columns in table 'ap1Ind41_hist':
 * @property integer $id
 ...
 */
class Ap1Ind41Hist extends CActiveRecord
{
    public $_archivo;
	/**
