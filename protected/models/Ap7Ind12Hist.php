...
/**
 * This is the model class for table "ap7Ind12_hist".
 *
 * The followings are the available columns in table 'ap7Ind12_hist':
 * @property integer $id
 ...
 */
class Ap7Ind12Hist extends CActiveRecord
{
    public $_archivo;
	/**
