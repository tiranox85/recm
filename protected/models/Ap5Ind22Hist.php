...
/**
 * This is the model class for table "ap5Ind22_hist".
 *
 * The followings are the available columns in table 'ap5Ind22_hist':
 * @property integer $id
 ...
 */
class Ap5Ind22Hist extends CActiveRecord
{
    public $_archivo;
	/**
