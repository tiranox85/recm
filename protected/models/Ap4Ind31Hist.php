...
/**
 * This is the model class for table "ap4Ind31_hist".
 *
 * The followings are the available columns in table 'ap4Ind31_hist':
 * @property integer $id
 ...
 */
class Ap4Ind31Hist extends CActiveRecord
{
    public $_archivo;
	/**
