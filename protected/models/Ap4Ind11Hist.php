...
/**
 * This is the model class for table "ap4Ind11_hist".
 *
 * The followings are the available columns in table 'ap4Ind11_hist':
 * @property integer $id
 ...
 */
class Ap4Ind11Hist extends CActiveRecord
{
    public $_archivo;
	/**
