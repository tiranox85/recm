...
/**
 * This is the model class for table "ap4Ind12_hist".
 *
 * The followings are the available columns in table 'ap4Ind12_hist':
 * @property integer $id
 ...
 */
class Ap4Ind12Hist extends CActiveRecord
{
    public $_archivo;
	/**
