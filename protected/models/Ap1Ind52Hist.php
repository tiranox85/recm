...
/**
 * This is the model class for table "ap1Ind52_hist".
 *
 * The followings are the available columns in table 'ap1Ind52_hist':
 * @property integer $id
 ...
 */
class Ap1Ind52Hist extends CActiveRecord
{
    public $_archivo;
	/**
