...
/**
 * This is the model class for table "ap8Ind21_hist".
 *
 * The followings are the available columns in table 'ap8Ind21_hist':
 * @property integer $id
 ...
 */
class Ap8Ind21Hist extends CActiveRecord
{
    public $_archivo;
	/**
