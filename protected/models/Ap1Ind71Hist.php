...
/**
 * This is the model class for table "ap1Ind71_hist".
 *
 * The followings are the available columns in table 'ap1Ind71_hist':
 * @property integer $id
 ...
 */
class Ap1Ind71Hist extends CActiveRecord
{
    public $_archivo;
	/**
