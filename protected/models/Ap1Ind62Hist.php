...
/**
 * This is the model class for table "ap1Ind62_hist".
 *
 * The followings are the available columns in table 'ap1Ind62_hist':
 * @property integer $id
 ...
 */
class Ap1Ind62Hist extends CActiveRecord
{
    public $_archivo;
	/**
