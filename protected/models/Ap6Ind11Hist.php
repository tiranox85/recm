...
/**
 * This is the model class for table "ap6Ind11_hist".
 *
 * The followings are the available columns in table 'ap6Ind11_hist':
 * @property integer $id
 ...
 */
class Ap6Ind11Hist extends CActiveRecord
{
    public $_archivo;
	/**
