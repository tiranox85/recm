...
/**
 * This is the model class for table "ap7Ind14_hist".
 *
 * The followings are the available columns in table 'ap7Ind14_hist':
 * @property integer $id
 ...
 */
class Ap7Ind14Hist extends CActiveRecord
{
    public $_archivo;
	/**
