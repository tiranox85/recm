...
/**
 * This is the model class for table "ap1Ind73_hist".
 *
 * The followings are the available columns in table 'ap1Ind73_hist':
 * @property integer $id
 ...
 */
class Ap1Ind73Hist extends CActiveRecord
{
    public $_archivo;
	/**
