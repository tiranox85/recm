...
/**
 * This is the model class for table "ap1Ind72_hist".
 *
 * The followings are the available columns in table 'ap1Ind72_hist':
 * @property integer $id
 ...
 */
class Ap1Ind72Hist extends CActiveRecord
{
    public $_archivo;
	/**
