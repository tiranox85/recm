...
/**
 * This is the model class for table "ap8Ind13_hist".
 *
 * The followings are the available columns in table 'ap8Ind13_hist':
 * @property integer $id
 ...
 */
class Ap8Ind13Hist extends CActiveRecord
{
    public $_archivo;
	/**
