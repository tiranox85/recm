...
/**
 * This is the model class for table "ap5Ind23_hist".
 *
 * The followings are the available columns in table 'ap5Ind23_hist':
 * @property integer $id
 ...
 */
class Ap5Ind23Hist extends CActiveRecord
{
    public $_archivo;
	/**
