...
/**
 * This is the model class for table "ap4Ind32_hist".
 *
 * The followings are the available columns in table 'ap4Ind32_hist':
 * @property integer $id
 ...
 */
class Ap4Ind32Hist extends CActiveRecord
{
    public $_archivo;
	/**
