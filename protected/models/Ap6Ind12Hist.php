...
/**
 * This is the model class for table "ap6Ind12_hist".
 *
 * The followings are the available columns in table 'ap6Ind12_hist':
 * @property integer $id
 ...
 */
class Ap6Ind12Hist extends CActiveRecord
{
    public $_archivo;
	/**
