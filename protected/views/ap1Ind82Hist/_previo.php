...
<div class="default">
        <table class="table_stats">
                <tr>
                        ...
                        <td colspan="19" class="span_time">Exportaciones de la industria manufacturera del Distrito Federal</td>
                </tr>
                ...
                if (is_array($valor2)){ 
                    foreach ($valor2 as $indice3 => $valor3) {
                        ...
                        if($indice3>1){
                            ...
                            echo"<tr class='rEven'><td class=''>".  utf8_encode($rubro['titulo'])."</td><td class='data'>".number_format($valor3['total'],0)."</td><td  class='data'>".round((($valor3['total']/$gran_total)*100),2)."</td></tr>";
                        }
