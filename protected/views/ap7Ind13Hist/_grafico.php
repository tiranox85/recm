...
?>
  ...
  <script type="text/javascript">
		...
		credits: false,
                ...
                title: {
                    text: 'Ingresos Tributarios Enero - Junio de 2014 <br> (Millones de pesos 2014)'
                    },
                    xAxis: {
                            title: {
                    text: 'Año'
		...
		yAxis: {
                ...
                $.getJSON("http://localhost/recm/index.php/api/ap7Ind13?serie=1&grafico=1", function(json) {
