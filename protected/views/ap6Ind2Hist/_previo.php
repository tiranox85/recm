...
//******estos son los promedios del periodo a consultar
            echo "<tr class='rEven'><td>Promedio</td>";
                echo "<td class='data'>".number_format($datos['promedios']['sumdf'],0)."</td><td class='data'>".number_format($datos['promedios']['promdf'],0)."</td><td class='data'>".number_format($datos['promedios']['sumnal'],0)."</td><td class='data'>".number_format($datos['promedios']['promnal'],0)."</td>";
            echo "</tr>";
