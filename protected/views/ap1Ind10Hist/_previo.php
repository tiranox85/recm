...
<p class="table_title default">
        Estadísticas de venta de energía eléctrica
</p>
   ...
   <tr class="cell_label"> 
    ...
    <tr>
        ...
        for($i=$trim_inicio;$i<=$trim_fin;$i++){
            ...
            echo "<tr class='rEven'><td>".$i."</td>";
            //****** al valor de cada columna se le suma 1
            for($x=1;$x<=6;$x++){
                echo "<td class='data'>".$datos[$x][$anio][$i]['valor']."</td><td class='data'>".round((($datos[$x][$anio][$i]['valor']/$datos[$x][$anio_ant][$i]["valor"])-1)*100, 2) ."%</td>";
            }
            echo "</tr>";
        }
