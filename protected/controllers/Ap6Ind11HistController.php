...
class Ap6Ind11HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $anios="2013,2014";
        $url = "http://localhost/recm/index.php/api/ap6Ind11?anios=2014&meses=1,2,3,0&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap6Ind11Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap6Ind11Hist'])) {
            $model->attributes = $_POST['Ap6Ind11Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap6Ind11Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap6Ind11Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap6Ind11Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap6Ind11Hist']))
            $model->attributes = $_GET['Ap6Ind11Hist'];
     ...
     * @return Ap6Ind11Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap6Ind11Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap6Ind11Hist $model the model to be validated
     */
