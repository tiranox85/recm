...
class Ap1Ind42HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $model=Ap1Ind42Hist::model()->findByPk($id);
    ...
    public function actionCreate() {
        ...
        $model = new Ap1Ind42Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap1Ind42Hist'])) {
            $model->attributes = $_POST['Ap1Ind42Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap1Ind42Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap1Ind42Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap1Ind42Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap1Ind42Hist']))
            $model->attributes = $_GET['Ap1Ind42Hist'];
     ...
     * @return Ap1Ind42Hist the loaded model
     ...
     * @param Ap1Ind42Hist $model the model to be validated
     */
