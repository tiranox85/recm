...
class Ap1Ind62HistController extends Controller {
    ...
    public function actionCreate() {
        ...
        $model = new Ap1Ind62Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap1Ind62Hist'])) {
            $model->attributes = $_POST['Ap1Ind62Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap1Ind62Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap1Ind62Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap1Ind62Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap1Ind62Hist']))
            $model->attributes = $_GET['Ap1Ind62Hist'];
     ...
     * @return Ap1Ind62Hist the loaded model
     ...
     * @param Ap1Ind62Hist $model the model to be validated
     */
