...
class Ap5Ind1HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $anios="2013,2014";
        $url = "http://localhost/recm/index.php/api/ap5Ind1?anios=2014&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap5Ind1Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap5Ind1Hist'])) {
            $model->attributes = $_POST['Ap5Ind1Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap5Ind1Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap5Ind1Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap5Ind1Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap5Ind1Hist']))
            $model->attributes = $_GET['Ap5Ind1Hist'];
     ...
     * @return Ap5Ind1Hist the loaded model
     ...
     * @param Ap5Ind1Hist $model the model to be validated
     */
