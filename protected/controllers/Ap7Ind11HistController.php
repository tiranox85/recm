...
class Ap7Ind11HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $url = "http://localhost/recm/index.php/api/ap7Ind11?anios=2014&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap7Ind11Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap7Ind11Hist'])) {
            $model->attributes = $_POST['Ap7Ind11Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap7Ind11Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap7Ind11Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap7Ind11Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap7Ind11Hist']))
            $model->attributes = $_GET['Ap7Ind11Hist'];
     ...
     * @return Ap7Ind11Hist the loaded model
     ...
     * @param Ap7Ind11Hist $model the model to be validated
     */
