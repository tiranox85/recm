...
class Ap3Ind32HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $model=Ap3Ind32Hist::model()->findByPk($id);
    ...
    public function actionCreate() {
        ...
        $model = new Ap3Ind32Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap3Ind32Hist'])) {
            $model->attributes = $_POST['Ap3Ind32Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap3Ind32Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap3Ind32Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap3Ind32Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap3Ind32Hist']))
            $model->attributes = $_GET['Ap3Ind32Hist'];
     ...
     * @return Ap3Ind32Hist the loaded model
     ...
     * @param Ap3Ind32Hist $model the model to be validated
     */
