...
class Ap1Ind71HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $url = "http://localhost/recm/index.php/api/ap1Ind71?anio=2014&trim_inicio=1&trim_fin=6&entidad=0,9,30,15,14,19,5,21&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap1Ind71Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap1Ind71Hist'])) {
            $model->attributes = $_POST['Ap1Ind71Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap1Ind71Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap1Ind71Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap1Ind71Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap1Ind71Hist']))
            $model->attributes = $_GET['Ap1Ind71Hist'];
     ...
     * @return Ap1Ind71Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap1Ind71Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap1Ind71Hist $model the model to be validated
     */
