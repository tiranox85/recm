...
class Ap6Ind2HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        //variable
        $anio=2014;
        $url = "http://localhost/recm/index.php/api/ap6Ind2?anios=2007,2008,2009,2010,2011,2012&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap6Ind2Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap6Ind2Hist'])) {
            $model->attributes = $_POST['Ap6Ind2Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap6Ind2Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap6Ind2Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap6Ind2Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap6Ind2Hist']))
            $model->attributes = $_GET['Ap6Ind2Hist'];
     ...
     * @return Ap6Ind2Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap6Ind2Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap6Ind2Hist $model the model to be validated
     */
