...
class Ap9Ind2HistController extends Controller {
    ...
    public function actionCreate() {
        ...
        $model = new Ap9Ind2Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap9Ind2Hist'])) {
            $model->attributes = $_POST['Ap9Ind2Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap9Ind2Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap9Ind2Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap9Ind2Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap9Ind2Hist']))
            $model->attributes = $_GET['Ap9Ind2Hist'];
     ...
     * @return Ap9Ind2Hist the loaded model
     ...
     * @param Ap9Ind2Hist $model the model to be validated
     */
