...
class Ap3Ind31HistController extends Controller {
    ...
    public function actionCreate() {
        ...
        $model = new Ap3Ind31Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap3Ind31Hist'])) {
            $model->attributes = $_POST['Ap3Ind31Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap3Ind31Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap3Ind31Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap3Ind31Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap3Ind31Hist']))
            $model->attributes = $_GET['Ap3Ind31Hist'];
     ...
     * @return Ap3Ind31Hist the loaded model
     ...
     * @param Ap3Ind31Hist $model the model to be validated
     */
