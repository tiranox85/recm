...
class Ap8Ind11HistController extends Controller {
    ...
    public function actionCreate() {
        ...
        $model = new Ap8Ind11Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap8Ind11Hist'])) {
            $model->attributes = $_POST['Ap8Ind11Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap8Ind11Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap8Ind11Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap8Ind11Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap8Ind11Hist']))
            $model->attributes = $_GET['Ap8Ind11Hist'];
     ...
     * @return Ap8Ind11Hist the loaded model
     ...
     * @param Ap8Ind11Hist $model the model to be validated
     */
