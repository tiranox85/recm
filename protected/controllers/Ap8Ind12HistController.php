...
class Ap8Ind12HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $url = "http://localhost/recm/index.php/api/ap8Ind12?anios=2014,2013,2012,2011,2010,2009,2008&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap8Ind12Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap8Ind12Hist'])) {
            $model->attributes = $_POST['Ap8Ind12Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap8Ind12Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap8Ind12Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap8Ind12Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap8Ind12Hist']))
            $model->attributes = $_GET['Ap8Ind12Hist'];
     ...
     * @return Ap8Ind12Hist the loaded model
     ...
     * @param Ap8Ind12Hist $model the model to be validated
     */
