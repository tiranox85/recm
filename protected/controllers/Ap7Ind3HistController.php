...
class Ap7Ind3HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $model=Ap7Ind3Hist::model()->findByPk($id);

        $url = "http://localhost/recm/index.php/api/ap7Ind3?anios=2014&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap7Ind3Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap7Ind3Hist'])) {
            $model->attributes = $_POST['Ap7Ind3Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap7Ind3Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap7Ind3Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap7Ind3Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap7Ind3Hist']))
            $model->attributes = $_GET['Ap7Ind3Hist'];
     ...
     * @return Ap7Ind3Hist the loaded model
     ...
     * @param Ap7Ind3Hist $model the model to be validated
     */
