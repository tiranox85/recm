...
class Ap5Ind21HistController extends Controller {
    ...
    public function actionCreate() {
        ...
        $model = new Ap5Ind21Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap5Ind21Hist'])) {
            $model->attributes = $_POST['Ap5Ind21Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap5Ind21Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap5Ind21Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap5Ind21Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap5Ind21Hist']))
            $model->attributes = $_GET['Ap5Ind21Hist'];
     ...
     * @return Ap5Ind21Hist the loaded model
     ...
     * @param Ap5Ind21Hist $model the model to be validated
     */
