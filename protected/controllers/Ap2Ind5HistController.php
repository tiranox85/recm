...
class Ap2Ind5HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $model=Ap2Ind5Hist::model()->findByPk($id);
    ...
    public function actionCreate() {
        ...
        $model = new Ap2Ind5Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap2Ind5Hist'])) {
            $model->attributes = $_POST['Ap2Ind5Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap2Ind5Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap2Ind5Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap2Ind5Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap2Ind5Hist']))
            $model->attributes = $_GET['Ap2Ind5Hist'];
     ...
     * @return Ap2Ind5Hist the loaded model
     ...
     * @param Ap2Ind5Hist $model the model to be validated
     */
