...
class Ap2Ind4HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        //variable
        $anio="2014,2013,2011,2010,2009";
        $url = "http://localhost/recm/index.php/api/ap2Ind4?anios=".$anio."&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap2Ind4Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap2Ind4Hist'])) {
            $model->attributes = $_POST['Ap2Ind4Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap2Ind4Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap2Ind4Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap2Ind4Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap2Ind4Hist']))
            $model->attributes = $_GET['Ap2Ind4Hist'];
     ...
     * @return Ap2Ind4Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap2Ind4Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap2Ind4Hist $model the model to be validated
     */
