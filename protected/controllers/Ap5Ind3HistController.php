...
class Ap5Ind3HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $entidades="1,2,3,4";
        $url = "http://localhost/recm/index.php/api/ap5Ind3?entidades=".$entidades."&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap5Ind3Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap5Ind3Hist'])) {
            $model->attributes = $_POST['Ap5Ind3Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap5Ind3Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap5Ind3Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap5Ind3Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap5Ind3Hist']))
            $model->attributes = $_GET['Ap5Ind3Hist'];
     ...
     * @return Ap5Ind3Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap5Ind3Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap5Ind3Hist $model the model to be validated
     */
