...
class Ap1Ind3HistController extends Controller {
    ...
    public function actionCreate() {
        ...
        $model = new Ap1Ind3Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap1Ind3Hist'])) {
            $model->attributes = $_POST['Ap1Ind3Hist'];
    ...
    public function actionAdmin() {
        $model = new Ap1Ind3Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap1Ind3Hist']))
            $model->attributes = $_GET['Ap1Ind3Hist'];
     ...
     * @return Ap1Ind3Hist the loaded model
     ...
     * @param Ap1Ind3Hist $model the model to be validated
     */
