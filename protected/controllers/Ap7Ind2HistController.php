...
class Ap7Ind2HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $url = "http://localhost/recm/index.php/api/ap7Ind2?anios=2014&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap7Ind2Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap7Ind2Hist'])) {
            $model->attributes = $_POST['Ap7Ind2Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap7Ind2Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap7Ind2Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap7Ind2Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap7Ind2Hist']))
            $model->attributes = $_GET['Ap7Ind2Hist'];
     ...
     * @return Ap7Ind2Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap7Ind2Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap7Ind2Hist $model the model to be validated
     */
