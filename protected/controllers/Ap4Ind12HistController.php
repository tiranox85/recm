...
class Ap4Ind12HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $model=Ap4Ind11Hist::model()->findByPk($id);
        $anios="2014,2013";
        $url = "http://localhost/recm/index.php/api/ap4Ind12?anios=".$anios."&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap4Ind12Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap4Ind12Hist'])) {
            $model->attributes = $_POST['Ap4Ind12Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap4Ind12Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap4Ind12Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap4Ind12Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap4Ind12Hist']))
            $model->attributes = $_GET['Ap4Ind12Hist'];
     ...
     * @return Ap4Ind12Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap4Ind12Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap4Ind12Hist $model the model to be validated
     */
