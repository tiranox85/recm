...
class Ap4Ind4HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $anios="2013,2014";
        $url = "http://localhost/recm/index.php/api/ap4Ind4?anios=2014,2013,2012&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap4Ind4Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap4Ind4Hist'])) {
            $model->attributes = $_POST['Ap4Ind4Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap4Ind4Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap4Ind4Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap4Ind4Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap4Ind4Hist']))
            $model->attributes = $_GET['Ap4Ind4Hist'];
     ...
     * @return Ap4Ind4Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap4Ind4Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap4Ind4Hist $model the model to be validated
     */
