...
class Ap1Ind72HistController extends Controller {
    ...
    public function actionCreate() {
        ...
        $model = new Ap1Ind72Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap1Ind72Hist'])) {
            $model->attributes = $_POST['Ap1Ind72Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap1Ind72Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap1Ind72Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap1Ind72Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap1Ind72Hist']))
            $model->attributes = $_GET['Ap1Ind72Hist'];
     ...
     * @return Ap1Ind72Hist the loaded model
     ...
     * @param Ap1Ind72Hist $model the model to be validated
     */
