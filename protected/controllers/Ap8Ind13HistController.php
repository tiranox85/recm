...
class Ap8Ind13HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $model=Ap8Ind13Hist::model()->findByPk($id);
    ...
    public function actionCreate() {
        ...
        $model = new Ap8Ind13Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap8Ind13Hist'])) {
            $model->attributes = $_POST['Ap8Ind13Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap8Ind13Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap8Ind13Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap8Ind13Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap8Ind13Hist']))
            $model->attributes = $_GET['Ap8Ind13Hist'];
     ...
     * @return Ap8Ind13Hist the loaded model
     ...
     * @param Ap8Ind13Hist $model the model to be validated
     */
