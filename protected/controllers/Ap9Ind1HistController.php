...
class Ap9Ind1HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $model=Ap9Ind1Hist::model()->findByPk($id);
        
        //variable
        $anio=2014;
        $url = "http://localhost/recm/index.php/api/ap9Ind1?anios=2014,2013,2012,2011,2010,2009&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap9Ind1Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap9Ind1Hist'])) {
            $model->attributes = $_POST['Ap9Ind1Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap9Ind1Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap9Ind1Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap9Ind1Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap9Ind1Hist']))
            $model->attributes = $_GET['Ap9Ind1Hist'];
     ...
     * @return Ap9Ind1Hist the loaded model
     ...
     * @param Ap9Ind1Hist $model the model to be validated
     */
