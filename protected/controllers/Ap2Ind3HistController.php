...
class Ap2Ind3HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        //variable
        $anio=2014;
        $url = "http://localhost/recm/index.php/api/ap2Ind3?anios=".$anio."&trim_inicio=1&trim_fin=6&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap2Ind3Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap2Ind3Hist'])) {
            $model->attributes = $_POST['Ap2Ind3Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap2Ind3Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap2Ind3Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap2Ind3Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap2Ind3Hist']))
            $model->attributes = $_GET['Ap2Ind3Hist'];
     ...
     * @return Ap2Ind3Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap2Ind3Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap2Ind3Hist $model the model to be validated
     */
