...
class Ap5Ind23HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $model=Ap5Ind23Hist::model()->findByPk($id);
        $anios="2014";
        $url = "http://localhost/recm/index.php/api/ap5Ind23?anios=".$anios."&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap5Ind23Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap5Ind23Hist'])) {
            $model->attributes = $_POST['Ap5Ind23Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap5Ind23Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap5Ind23Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap5Ind23Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap5Ind23Hist']))
            $model->attributes = $_GET['Ap5Ind23Hist'];
     ...
     * @return Ap5Ind23Hist the loaded model
     ...
     * @param Ap5Ind23Hist $model the model to be validated
     */
