...
class Ap4Ind11HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $anios="2014";
        $url = "http://localhost/recm/index.php/api/ap4Ind11?anios=".$anios."&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap4Ind11Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap4Ind11Hist'])) {
            $model->attributes = $_POST['Ap4Ind11Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap4Ind11Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap4Ind11Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap4Ind11Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap4Ind11Hist']))
            $model->attributes = $_GET['Ap4Ind11Hist'];
     ...
     * @return Ap4Ind11Hist the loaded model
     ...
     * @param Ap4Ind11Hist $model the model to be validated
     */
