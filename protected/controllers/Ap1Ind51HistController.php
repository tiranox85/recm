...
class Ap1Ind51HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $model=Ap1Ind51Hist::model()->findByPk($id);
    ...
    public function actionCreate() {
        ...
        $model = new Ap1Ind51Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap1Ind51Hist'])) {
            $model->attributes = $_POST['Ap1Ind51Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap1Ind51Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap1Ind51Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap1Ind51Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap1Ind51Hist']))
            $model->attributes = $_GET['Ap1Ind51Hist'];
     ...
     * @return Ap1Ind51Hist the loaded model
     ...
     * @param Ap1Ind51Hist $model the model to be validated
     */
