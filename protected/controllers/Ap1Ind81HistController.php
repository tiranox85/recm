...
class Ap1Ind81HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $url = "http://localhost/recm/index.php/api/ap1Ind81?anios=2007,2008,2009,2010,2011,2012&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap1Ind81Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap1Ind81Hist'])) {
            $model->attributes = $_POST['Ap1Ind81Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap1Ind81Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap1Ind81Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap1Ind81Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap1Ind81Hist']))
            $model->attributes = $_GET['Ap1Ind81Hist'];
     ...
     * @return Ap1Ind81Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap1Ind81Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap1Ind81Hist $model the model to be validated
     */
