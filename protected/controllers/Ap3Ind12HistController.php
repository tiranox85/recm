...
class Ap3Ind12HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $model=Ap3Ind12Hist::model()->findByPk($id);
        
        //variable
        $anio=2014;
        $url = "http://localhost/recm/index.php/api/ap3Ind12?anios=".$anio."&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap3Ind12Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap3Ind12Hist'])) {
            $model->attributes = $_POST['Ap3Ind12Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap3Ind12Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap3Ind12Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap3Ind12Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap3Ind12Hist']))
            $model->attributes = $_GET['Ap3Ind12Hist'];
     ...
     * @return Ap3Ind12Hist the loaded model
     ...
     * @param Ap3Ind12Hist $model the model to be validated
     */
