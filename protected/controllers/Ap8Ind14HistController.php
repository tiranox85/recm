...
class Ap8Ind14HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $model=Ap8Ind14Hist::model()->findByPk($id);
    ...
    public function actionCreate() {
        ...
        $model = new Ap8Ind14Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap8Ind14Hist'])) {
            $model->attributes = $_POST['Ap8Ind14Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap8Ind14Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap8Ind14Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap8Ind14Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap8Ind14Hist']))
            $model->attributes = $_GET['Ap8Ind14Hist'];
     ...
     * @return Ap8Ind14Hist the loaded model
     ...
     * @param Ap8Ind14Hist $model the model to be validated
     */
