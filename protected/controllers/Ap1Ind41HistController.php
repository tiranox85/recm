...
class Ap1Ind41HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $model=Ap1Ind41Hist::model()->findByPk($id);
    ...
    public function actionCreate() {
        ...
        $model = new Ap1Ind41Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap1Ind41Hist'])) {
            $model->attributes = $_POST['Ap1Ind41Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap1Ind41Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap1Ind41Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap1Ind41Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap1Ind41Hist']))
            $model->attributes = $_GET['Ap1Ind41Hist'];
     ...
     * @return Ap1Ind41Hist the loaded model
     ...
     * @param Ap1Ind41Hist $model the model to be validated
     */
