...
class Ap5Ind22HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $anios="2012";
        $url = "http://localhost/recm/index.php/api/ap5Ind22?anios=".$anios."&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap5Ind22Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap5Ind22Hist'])) {
            $model->attributes = $_POST['Ap5Ind22Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap5Ind22Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap5Ind22Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap5Ind22Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap5Ind22Hist']))
            $model->attributes = $_GET['Ap5Ind22Hist'];
     ...
     * @return Ap5Ind22Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap5Ind22Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap5Ind22Hist $model the model to be validated
     */
