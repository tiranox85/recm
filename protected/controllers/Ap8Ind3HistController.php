...
class Ap8Ind3HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $url = "http://localhost/recm/index.php/api/ap8Ind3?anios=2014&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap8Ind3Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap8Ind3Hist'])) {
            $model->attributes = $_POST['Ap8Ind3Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap8Ind3Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap8Ind3Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap8Ind3Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap8Ind3Hist']))
            $model->attributes = $_GET['Ap8Ind3Hist'];
     ...
     * @return Ap8Ind3Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap8Ind3Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap8Ind3Hist $model the model to be validated
     */
