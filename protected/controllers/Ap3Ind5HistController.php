...
class Ap3Ind5HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $anios="2014";
        $url = "http://localhost/recm/index.php/api/ap3Ind5?anios=".$anios."&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap3Ind5Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap3Ind5Hist'])) {
            $model->attributes = $_POST['Ap3Ind5Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap3Ind5Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap3Ind5Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap3Ind5Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap3Ind5Hist']))
            $model->attributes = $_GET['Ap3Ind5Hist'];
     ...
     * @return Ap3Ind5Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap3Ind5Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap3Ind5Hist $model the model to be validated
     */
