...
class Ap4Ind2HistController extends Controller {
    ...
    public function actionPrevio($id)
    {
        ...
        $anios="2013,2014";
        $url = "http://localhost/recm/index.php/api/ap4Ind2?anios=".$anios."&grafico=0";
        //$url = $baseUrl;
    ...
    public function actionCreate() {
        ...
        $model = new Ap4Ind2Hist;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['Ap4Ind2Hist'])) {
            $model->attributes = $_POST['Ap4Ind2Hist'];
    ...
    public function actionIndex() {
        ...
        $item_count = Ap4Ind2Hist::model()->count($criteria);

        $pages = new CPagination($item_count);
        $pages->setPageSize(10);
        $pages->applyLimit($criteria);  // the trick is here!

        $model= Ap4Ind2Hist::model()->findAll($criteria);
    ...
    public function actionAdmin() {
        $model = new Ap4Ind2Hist('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Ap4Ind2Hist']))
            $model->attributes = $_GET['Ap4Ind2Hist'];
     ...
     * @return Ap4Ind2Hist the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Ap4Ind2Hist::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Ap4Ind2Hist $model the model to be validated
     */
